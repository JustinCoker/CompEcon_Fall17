...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="50000" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{d11ca40b-6268-4555-825b-32bdcb80f057}">
      <rule scalemaxdenom="25000" checkstate="0" key="{51ac1b07-6be0-4d25-b14d-e7ca21bebca4}" scalemindenom="1" label="1:25000">
        <rule filter="&quot;TYPE&quot; = 'Motorway or highway'" key="{6c333b3a-ecff-49dd-8918-f42e91b504c5}" symbol="0" label="Motorway or highway"/>
        <rule filter="&quot;TYPE&quot; = 'Motorway link'" key="{6c26b2ca-eb4c-4253-8c8d-437375404f4f}" symbol="1" label="Motorway Link"/>
        <rule filter="&quot;TYPE&quot; = 'Primary road'" key="{49cde8c2-6b61-47af-8047-24e1ff3a536f}" symbol="2" label="Primary road"/>
        <rule filter="&quot;TYPE&quot; = 'Primary link'" key="{2685c8fc-ea1d-4ccc-8897-acbfc42b2252}" symbol="3" label="Primary link"/>
        <rule filter="&quot;TYPE&quot; = 'Tertiary'" key="{f44fe285-859f-4d40-8d50-ac59c6fe9f7e}" symbol="4" label="Tertiary"/>
        <rule filter="&quot;TYPE&quot; = 'Tertiary link'" key="{f970a95c-2820-4bc2-ae4b-a4f5c8f9a83e}" symbol="5" label="Tertiary link"/>
        <rule filter="&quot;TYPE&quot; = 'Secondary'" key="{1dfdecb2-81c7-4c2e-aca6-bde727d947cb}" symbol="6" label="Secondary"/>
        <rule filter="&quot;TYPE&quot; = 'Secondary link'" key="{71f99d9c-f279-499e-a41a-987de4a9aa5c}" symbol="7" label="Secondary link"/>
        <rule filter="&quot;TYPE&quot; = 'Road, residential, living street, etc.'" key="{dcef986f-2965-4678-97e4-ca55f995139f}" symbol="8" label="Road, residential, living street, etc."/>
        <rule filter="&quot;TYPE&quot; = 'Track'" key="{6cde1f98-17fd-4033-a057-065ab1a15a43}" symbol="9" label="Track"/>
        <rule filter="&quot;TYPE&quot; = 'Cycleway, footpath, etc.'" key="{a1b0f5f4-9537-4a46-af80-be2cc506e91f}" symbol="10" label="Cycleway, footpath etc."/>
      </rule>
      <rule scalemaxdenom="50000" checkstate="0" key="{5c22ae03-e54f-4c8a-b3a4-064a70875d90}" symbol="11" scalemindenom="25001" label="25k to 50k">
        <rule filter=" &quot;TYPE&quot;  =  'Motorway or highway'" key="{8a2a6254-4428-4d47-9917-fc7f524ccf88}" symbol="12" label="Motorway or highway"/>
        <rule filter="&quot;TYPE&quot; = 'Primary road'" key="{08c81f4e-6a9c-49d7-9999-19dd0a009c74}" symbol="13" label="Primary"/>
      </rule>
      <rule scalemaxdenom="10000000" key="{046ac68c-8b37-4096-a429-0ae0511172aa}" symbol="14" scalemindenom="500" label="50k +">
        <rule filter=" &quot;TYPE&quot;  =  'Motorway or highway' " key="{749ef579-e078-466b-9e43-8d6af6e642d7}" symbol="15" label="Motorway or highway"/>
      </rule>
    </rules>
    <symbols>
